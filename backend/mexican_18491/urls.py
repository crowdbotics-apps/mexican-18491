"""mexican_18491 URL Configuration
...
admin.site.site_header = "mexican"
admin.site.site_title = "mexican Admin Portal"
admin.site.index_title = "mexican Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="mexican API",
        default_version="v1",
        description="API documentation for mexican App",
    ),
    public=True,
